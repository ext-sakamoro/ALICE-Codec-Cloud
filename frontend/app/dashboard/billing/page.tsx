...
const plans = [
  { name: 'Free', price: '$0/mo', features: ['10 encodes/day', '720p max resolution', 'Haar wavelet only', 'Community support'] },
  { name: 'Pro', price: '$149/mo', features: ['Unlimited encodes', '4K resolution', 'CDF 9/7 + Daubechies wavelets', 'rANS entropy coding', 'Batch transcode', 'Priority support'] },
  { name: 'Enterprise', price: 'Custom', features: ['Unlimited everything', '8K+ resolution', 'Custom codecs', 'GPU acceleration', 'SLA 99.99%', 'Dedicated support'] },
];
